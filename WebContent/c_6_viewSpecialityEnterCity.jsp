...
<body>
    <div class="container">
        <div class="title">View All Chef City Wise and Spciality wise</div>
        <form action="c_7_ViewDetailsOfChef_Book.jsp">
            <div class="user-detail">
                ...
                <div class="input-box">
                    <div class="detail">Chef Speciality</div>
                    <input type="text" placeholder="Enter Chef Speciality" name="speciality">
                </div>
